...
<p>
```{r hello-benji,echo=FALSE,fig.cap='Data Science for Hospitality – Turning Data into Profit',fig.align='center'}
knitr::include_url('https://www.youtube.com/watch?v=ujsjekDb1ck')
```
