...
<p>
```{r Data-Science,echo=FALSE,fig.cap='Personalized Service and Pricing for Hotel Loyal Guests - Charlene Chen',fig.align='center'}
knitr::include_url('https://drive.google.com/file/d/1cxeChXAymlQm2-dzR2_dg99h_oi6Lx9D/preview')
```
